classdef twodancers_many_emily_twoexperiments_optimize_body_markers
    ...
    methods
        function obj = twodancers_many_emily_twoexperiments_optimize_body_markers(Dataset1_24Dyads,Dataset2_37Dyads, NPC,t1,t2,isomorphismorder,coordinatesystem,TDE,kinemfeat)
        % Syntax e.g.:
        % a = twodancers_many_emily_twoexperiments_optimize_body_markers('Dataset1_24Dyads.mat','Dataset2_37Dyads',5,5,20,1,'global','noTDE','vel');
